  ...
  return (
    <header className="sticky top-0 z-40 bg-background/90 backdrop-blur-md border-b border-border/60">
      ...
      <div className="container flex items-center justify-between h-16 md:h-24 gap-2">
        ...
        {/* Desktop nav */}
        <nav className="hidden md:flex items-center gap-3 lg:gap-8 flex-1 whitespace-nowrap">
          {NAV.map((n) => (
        ...
        >
          <img
            src={tintelleLogo}
            alt="Tintelle Beauty"
            className="h-12 md:h-28 lg:h-28 w-auto object-contain md:scale-110 lg:scale-100 origin-center"
            loading="eager"
            decoding="sync"
            // @ts-ignore
            fetchpriority="high"
