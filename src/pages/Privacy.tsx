...
const sections = [
  { id: "scope", title: "1. Scope", content: <p>This policy explains how Tintelle collects, uses, and protects information when you visit tintelle.com or buy our products.</p> },
  ...
  { id: "rights", title: "6. Your rights", content: <p>You may request access, correction, export, or deletion of your data anytime by emailing privacy@tintelle.com.</p> },
  ...
  { id: "contact", title: "10. Contact", content: <p>Questions about this policy: <a className="text-primary" href="mailto:privacy@tintelle.com">privacy@tintelle.com</a>.</p> },
];
